...
**Gameplay Purpose:** terrain, tutorial route, low obstacles, transitions  
...
**Required Variants:** terrain, tutorial route, low obstacles, transitions  
**Permanent Visual Invariants:** fresh tan soil beds, spring-green grass, readable vegetable rows, low rounded fences, generous tutorial paths and very sparse collision props; rounded #2b1a14-brown structural accents, upper-left light, cream/mint shared Floor 1 base, sparse decoration, mobile path readability  
...
fresh tan soil beds, spring-green grass, readable vegetable rows, low rounded fences, generous tutorial paths and very sparse collision props. **Code–GDD Conflict C2:** this zone is explicit in the GDD but has no distinct runtime asset ID or slicing contract.

### Copy-Ready Main Prompt

Create an original Odd Tower environment style board and modular terrain family for Beginner Vegetable Patch. Visual language: fresh tan soil beds, spring-green grass, readable vegetable rows, low rounded fences, generous tutorial paths and very sparse collision props. Show center terrain, four outer edges, four outer corners, four inner corners, one transition into the shared cream-and-mint Floor 1 base, two restrained decorative variations, and clear examples of terrain, tutorial route, low obstacles, transitions. Orthographic top-down, tile-grid aligned, saturated pastel food-fantasy color, rounded chocolate-brown structural lines based on #2b1a14, upper-left light, low detail density, large readable paths, no text, no characters, no isometric perspective. Dimensions and final slicing remain unconfirmed.
...
- **Gameplay states:** terrain, tutorial route, low obstacles, transitions; communicate without text.
