...
## PENDING-F1-012 — Chocolate Swamp Environment Family

**Category:** Environment  
**MVP or Post-MVP:** Floor 1 MVP Batch 2  
**Source:** GDD §9 lines 275–279  
...
**Gameplay Purpose:** terrain, slow zones, transitions, hazard cues  
...
**Required Variants:** terrain, slow zones, transitions, hazard cues  
**Permanent Visual Invariants:** milk-chocolate mud pools, cream-to-cocoa transitions, large slow-zone shapes, candy reeds, broad bubbles, sparse logs and stepping stones; rounded #2b1a14-brown structural accents, upper-left light, cream/mint shared Floor 1 base, sparse decoration, mobile path readability  
...
milk-chocolate mud pools, cream-to-cocoa transitions, large slow-zone shapes, candy reeds, broad bubbles, sparse logs and stepping stones. **Code–GDD Conflict C2:** this zone is explicit in the GDD but has no distinct runtime asset ID or slicing contract.

### Copy-Ready Main Prompt

Create an original Odd Tower environment style board and modular terrain family for Chocolate Swamp. Visual language: milk-chocolate mud pools, cream-to-cocoa transitions, large slow-zone shapes, candy reeds, broad bubbles, sparse logs and stepping stones. Show center terrain, four outer edges, four outer corners, four inner corners, one transition into the shared cream-and-mint Floor 1 base, two restrained decorative variations, and clear examples of terrain, slow zones, transitions, hazard cues. Orthographic top-down, tile-grid aligned, saturated pastel food-fantasy color, rounded chocolate-brown structural lines based on #2b1a14, upper-left light, low detail density, large readable paths, no text, no characters, no isometric perspective. Dimensions and final slicing remain unconfirmed.
...
- **Gameplay states:** terrain, slow zones, transitions, hazard cues; communicate without text.
