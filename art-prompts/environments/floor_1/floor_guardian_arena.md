...
**Gameplay Purpose:** closed, unlocked, encounter-active states  
...
**Required Variants:** closed, unlocked, encounter-active states  
**Permanent Visual Invariants:** large cream tile arena with freezer-blue border insets, clear frontal attack lanes, sealed entrance, shared-encounter ring and sparse frozen debris; rounded #2b1a14-brown structural accents, upper-left light, cream/mint shared Floor 1 base, sparse decoration, mobile path readability  
...
large cream tile arena with freezer-blue border insets, clear frontal attack lanes, sealed entrance, shared-encounter ring and sparse frozen debris. **Code–GDD Conflict C2/C6:** this zone is explicit in the GDD but has no distinct runtime asset ID or slicing contract.

### Copy-Ready Main Prompt

Create an original Odd Tower environment style board and modular terrain family for Floor Guardian Arena. Visual language: large cream tile arena with freezer-blue border insets, clear frontal attack lanes, sealed entrance, shared-encounter ring and sparse frozen debris. Show center terrain, four outer edges, four outer corners, four inner corners, one transition into the shared cream-and-mint Floor 1 base, two restrained decorative variations, and clear examples of closed, unlocked, encounter-active states. Orthographic top-down, tile-grid aligned, saturated pastel food-fantasy color, rounded chocolate-brown structural lines based on #2b1a14, upper-left light, low detail density, large readable paths, no text, no characters, no isometric perspective. Dimensions and final slicing remain unconfirmed.
...
- **Gameplay states:** closed, unlocked, encounter-active states; communicate without text.
