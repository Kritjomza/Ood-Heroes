...
export const FLOOR_ONE_ASSETS: readonly FloorOneAsset[] = [
  ...
  asset('floor1.transition.honey-mint', 'transitions/honey-to-mint.webp', 'transition', 'all', { rotate: true, mirror: true }),
  asset('floor1.transition.mint-cocoa', 'transitions/mint-to-cocoa.webp', 'transition', 'all', { rotate: true, mirror: true }),
  asset('floor1.transition.cocoa-honey', 'transitions/cocoa-to-honey.webp', 'transition', 'all', { rotate: true, mirror: true }),
